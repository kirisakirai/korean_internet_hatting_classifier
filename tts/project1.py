...
# OpenAI API 설정
API_KEY = "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"
...
class text_to_speech:
    def __init__(self):
        subscription_key = "64a8f092901649029ba7bcd3032a3847"
        region = "koreacentral"
...
class Bot(commands.Bot):
    def __init__(self):
        super().__init__(token='7qoqvdvi1r14078pccrlrrdspzi5ro', prefix='!', initial_channels=['sudal135'])
